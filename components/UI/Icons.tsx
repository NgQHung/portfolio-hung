...
export const GithubIcon: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
...
export const TwitterIcon: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
// #0A66C2
export const LinkedInIcon: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const PinterestIcon: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const DribbbleIcon: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const SunIcon: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const MoonIcon: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const LeftArrow: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
...
export const EmailIcon: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        data-name="1-Email"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 32 32"
...
export const LinkArrow: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={24}
        height={24}
...
export const WebsiteIcon: React.FC<IIcons> = ({className, ...rest}) => (
    <svg
        width="800px"
        height="800px"
        viewBox="0 0 24 24"
