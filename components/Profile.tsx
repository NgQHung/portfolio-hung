        ...
        >
          ...
          <div className="w-[300px] xs:w-[400px] flex justify-center flex-col items-center mx-5">
            ...
            <p className=" text-center text-xs xs:text-sm my-2">
              I am a front-end web developer. I like creating new things and
              explore more about the world code. Currently I am moving towards
              the back-end and becoming a full-stack developer. Hope you are
