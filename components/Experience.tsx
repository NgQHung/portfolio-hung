    ...
    return (
        <>
            ...
            <div
                ...
                className="dark:border-b dark:border-primary sm:border-none lg:hidden h-full sticky top-0 z-20 w-full left-0 bg-primary opacity:0.9  dark:bg-[#1a1a1a] dark:shadow-lg dark:opacity-100   ">
                <h1
