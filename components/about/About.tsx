...
const About = () => {
    return (
        <div
            id="about"
            className="  lg:py-16 xl:py-20 text-black dark:text-primary lg:pl-4 pb-16  lg:pb:0">
            <div
            ...
            <div className="pr-8 p-8  lg:px-12 xl:px-16 text-sm sm:text-base  pt-8  lg:pt-16 ">
                <p className="mb-4">
