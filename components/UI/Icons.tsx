...
export const GithubIcon: React.FC<IIcons> = (props) => (
    <svg
...
// fill = '#fff';
//
export const LinkedInIcon: React.FC<IIcons> = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
        viewBox="0 0 256 256"
        className={`w-full h-auto ${props.className} dark:rounded-full`}>
...
export const EmailIcon: React.FC<IIcons> = (props) => (
    <svg
        data-name="1-Email"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 32 32"
        className={`w-full h-auto dark:p-[3px] ${props.className}`}>
        <path
            fill={props.color}
...
export const LeftArrow: React.FC<IIcons> = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
...
export const LinkArrow: React.FC<IIcons> = (props) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={24}
        height={24}
...
export const WebsiteIcon: React.FC<IIcons> = (props) => (
    <svg
        width="800px"
        height="800px"
        viewBox="0 0 24 24"
...
// export const PinterestIcon: React.FC<IIcons> = (props) => (
//     <svg
//         xmlns="http://www.w3.org/2000/svg"
//         width="1em"
//         height="1em"
...
// export const DribbbleIcon: React.FC<IIcons> = (props) => (
//     <svg
//         xmlns="http://www.w3.org/2000/svg"
//         width="1em"
//         height="1em"
