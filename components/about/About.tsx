    ...
    return (
        <div
            ...
            <div
                ...
                className="h-full sticky top-0 z-20 w-full left-0 bg-primary opacity:0.9 dark:bg-[#1a1a1a] dark:shadow-lg dark:opacity-100   ">
                <h1 className="block lg:hidden font-bold py-6 text-2xl px-4 sm:px-8 ">About</h1>
            </div>
            <div className="pr-8 p-8 px-4 lg:px-12 xl:px-16 text-sm sm:text-base  pt-8  lg:pt-16 ">
                <p className="mb-4">
